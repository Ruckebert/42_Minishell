...
SOURCE = main.c executor/here_doc.c executor/multi_pipe.c executor/file_redirections.c builtins/builtins.c  builtins/builtin_utils.c  builtins/export.c  builtins/unset.c executor/executor.c executor/executor_utils.c environment.c
