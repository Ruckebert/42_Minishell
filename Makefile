...
SOURCETOK = ./tokenizer/testing.c signal.c freefuncs.c ./tokenizer/token.c ./tokenizer/lsthelper.c ./tokenizer/tokenhelper.c ./tokenizer/tokenhelper2.c ./tokenizer/tokenhelper3.c
